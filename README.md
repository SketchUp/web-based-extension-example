...
A typical example is an AI rendering or energy analysis but also a product
catalog.
...
the full 3D model file could also be sent to the server.
...
```ruby
path = "C:/Users/cenerot/SketchUp Extensions/web-based-extension/src"
$LOAD_PATH << path
